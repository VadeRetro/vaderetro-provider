drop table if exists keystore_entries, keystore_metadata, keystore_hostnames;
...
create table keystore_hostnames (alias varchar(256) not null, rank int default 0, hostname varchar(256) not null, primary key (alias, rank, hostname), key (hostname));
