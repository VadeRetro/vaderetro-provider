...
create table keystore_entries  (alias varchar(256) not null, entry_type int default 0, rank int default 0, creation_date bigint default 0, algorithm varchar(256), data blob not null, primary key (alias, entry_type, rank));
