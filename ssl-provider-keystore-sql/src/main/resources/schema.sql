...
create table keystore_entries (alias_hash varchar(64) not null, alias varchar(256) not null, entry_type int default 0, rank int default 0, creation_date bigint default 0, algorithm varchar(256), data text not null, primary key (alias_hash, entry_type, rank), key (entry_type));
