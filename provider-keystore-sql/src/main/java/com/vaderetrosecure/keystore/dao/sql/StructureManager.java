...
class StructureManager
{
    ...
    public void manageEntriesTable() throws KeyStoreDAOException
    {
        ...
        sb.append(" (");
        sb.append("alias_hash varchar(64) not null");
        sb.append(",");
        sb.append("entry_type int default 0");
        sb.append(",");
        sb.append("alias varchar(256) not null");
        sb.append(",");
        sb.append("creation_date bigint default 0");
        sb.append(",");
        sb.append("algorithm varchar(32)");
        sb.append(",");
        sb.append("data text not null");
        sb.append(",");
        sb.append("protection_key text");
        sb.append(",");
        sb.append("protection_param varchar(128)");
        sb.append(",");
    ...
    public void manageNamesTable() throws KeyStoreDAOException
    {
        ...
        sb.append("alias_hash varchar(64) not null");
        sb.append(",");
        sb.append("name_hash varchar(64) not null");
        sb.append(",");
        sb.append("name varchar(256) not null");
        sb.append(",");
        sb.append("primary key(alias_hash, name_hash)");
        sb.append(",");
    ...
    public void manageIntegrityTable() throws KeyStoreDAOException
    {
        ...
        sb.append(",");
        sb.append("salt varchar(128) not null");
        sb.append(",");
        sb.append("iv varchar(128) not null");
        sb.append(",");
        sb.append("data varchar(256) not null");
        sb.append(",");
        sb.append("data_hash varchar(64) not null");
        sb.append(",");
